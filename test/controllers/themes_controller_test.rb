...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { description: @theme.description, image: @theme.image, title: @theme.title } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { description: @theme.description, image: @theme.image, title: @theme.title } }
